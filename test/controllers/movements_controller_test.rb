...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post movements_url, params: { movement: { account_id: @movement.account_id, amount: @movement.amount, date: @movement.date, description: @movement.description, type: @movement.type, user_id: @movement.user_id } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { account_id: @movement.account_id, amount: @movement.amount, date: @movement.date, description: @movement.description, type: @movement.type, user_id: @movement.user_id } }
